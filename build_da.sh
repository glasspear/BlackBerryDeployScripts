...
# DevAlpha/BB10 device details
ip="device ip"
password="yourpassword"
signpassword="yoursigningpassword"

# path for libraries
pathtobbwp="/Developer/SDKs/Research In Motion/BlackBerry 10 WebWorks SDK 1.0.0.7"
pathtobin="$pathtobbwp/dependencies/tools/bin"
pathtoapp="/Users/rory/Sites/$1/bb10" #this is the source folder for your app
pathtobuild="/Users/rory/Sites/builds/$1/bb10" # This is the directory where your app will be built to
